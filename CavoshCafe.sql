...
create procedure sp_getClienteCodigoValidar(in _id int, in _codigo int)
	begin
        ...
        select timestampdiff(minute, _fechaCaducidad, time());
	end
//

call sp_setCliente(0,"Armando","armandoyt19@gmail.com","1234");
call sp_getCliente("luisa@gmail.com","123")
call sp_getClienteCodigo("luisa@gmail.com")
